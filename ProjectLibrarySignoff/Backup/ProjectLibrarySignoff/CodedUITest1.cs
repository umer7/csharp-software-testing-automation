...
namespace ProjectLibrarySignoff
{
    /// <summary>
    ...
    public class CodedUITest1
    {
        ...
        [TestMethod]
        public void SignOffDriver()
        {
            SignoffParams signoffParams = new SignoffParams()
            {
               SignoffComment = "Test",
               SignoffUser1 = "a1",
               SignoffUser1Password = "Karachi1.",
               SignoffUser2 = "w1",
               SignoffUser2Password = "Karachi123"
            };

           Signoff signoff = new Signoff();
           // signoff.SingleSignoff(signoffParams);
